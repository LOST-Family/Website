...
<style>
  ...
  .hero.mounted .hero-scroll-indicator {
    animation: fadeIn 1s ease 0.5s forwards, float 2s ease-in-out 1.5s infinite;
    opacity: 0;
  }
  ...
  .hero.light .hero-scroll-indicator {
