...
<section class="content-section" id="{gameType}-clans" class:light={theme === 'light'}>
  <div class="section-container full-width">
    <div class="section-header with-stats">
      <div class="section-header-left">
        <div class="section-icon clan-icon" class:coc={isCoc} class:cr={!isCoc}>
          {#if isCoc}
      ...
      {#if clanCount > 0}
        <div class="section-stats">
          <span class="stat-badge" class:coc={isCoc} class:cr={!isCoc}>{clanCount} Clans</span>
          <span class="stat-badge" class:coc={isCoc} class:cr={!isCoc}>{playerCount} Spieler</span>
        </div>
      {/if}
    </div>
